    ...
    */
    ...
    this.InitializeGame = function(difficulty) {
        ...
        switch(difficulty)
        {
            ...
            {
                player = new Player();
                player.Initialize('A1', false, difficulty, 'West');
                this.players.push(player);
                player = new Player();
                player.Initialize('A2', false, difficulty, 'North');
                this.players.push(player);
                player = new Player();
                player.Initialize('A3', false, difficulty, 'East');
                this.players.push(player);
            }
            break;
            case 'Standard':
    ...
    this.FinishRound = function() {
        ...
        for (var i=0; i<4; i++) {
            ...
            if (player.currentRoundBid == 0) {
                ...
                aRoundScores.push(-player.currentRoundBid*10);
            } else {
